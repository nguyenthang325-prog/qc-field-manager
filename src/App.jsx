...
// ── LỖI THƯỜNG GẶP (cảnh báo cho QC mới) ───────────────────────────────────────
const defectData = {
  ct: [
    { id: "dct1", t: "Nối chồng cốt thép dồn tại 1 vị trí", hd: "Thợ hay nối các thanh cùng một mặt cắt cho nhanh, thay vì so le — kiểm tra mặt cắt ngang, không quá 50% số thanh nối tại cùng vị trí." },
    { id: "dct2", t: "Thiếu hoặc sai chiều cao con kê", hd: "Thiếu con kê → thép chìm sát đáy khi đổ BT, sai lớp bảo vệ. Đừng tin lời thợ \"đã kê đủ\" — tự đếm mật độ con kê trước khi cho đổ." },
    { id: "dct3", t: "Đo khoảng cách thép khi còn bùn đất che mặt", hd: "Bùn đất/dầu mỡ làm sai lệch kết quả đo bằng mắt — luôn cạo sạch tại vị trí đo, không đo qua lớp bẩn." },
  ],
  vk: [
    { id: "dvk1", t: "Cây chống đà giáo thưa hơn biện pháp đã duyệt", hd: "Thợ tự giảm số cây chống để thi công nhanh — đối chiếu khoảng cách thực tế với bản vẽ biện pháp, không chỉ nhìn \"có chống là được\"." },
    { id: "dvk2", t: "Bưng khe hở ván khuôn tạm bằng giấy/bao xi măng", hd: "Cách này không kín, dễ chảy nước xi măng ra ngoài → rỗ mặt BT. Phải xử lý kín khít bằng keo/foam chuyên dụng." },
    { id: "dvk3", t: "Không kiểm tra lại cao độ, tim sau khi dựng xong", hd: "VK dễ bị xô lệch trong lúc lắp thép, đi lại thi công — kiểm tra lại ngay trước giờ đổ BT, không chỉ kiểm tra lúc mới dựng." },
  ],
  bt: [
    { id: "dbt1", t: "Nhận xe BT không kiểm tra phiếu & giờ xuất xưởng", hd: "Xe chạy quá 90 phút vẫn cho đổ vì \"thấy còn lỏng\" — phải từ chối, BT đã mất độ sụt và giảm cường độ." },
    { id: "dbt2", t: "Thử độ sụt qua loa, sai quy trình côn Abrams", hd: "Đổ vội, rút côn quá nhanh/quá chậm → kết quả không đại diện cho cả mẻ. Làm đúng từng bước, đo ngay khi xe vừa đến." },
    { id: "dbt3", t: "Lấy mẫu nén tại miệng bơm hoặc cuối xe", hd: "Vị trí này không đại diện chất lượng thực — phải lấy mẫu ngay tại vị trí đổ, giữa quá trình đổ." },
  ],
  tm: [
    { id: "dtm1", t: "Thi công khi bề mặt còn ẩm đọng nước/còn bụi", hd: "Lớp chống thấm không bám dính được, bong ngay sau vài tháng — bề mặt phải sạch và chỉ ẩm nhẹ theo đúng hướng dẫn vật liệu." },
    { id: "dtm2", t: "Bỏ qua gia cường vải tại góc chân tường, cổ ống", hd: "Đây là vị trí thấm nhiều nhất do co giãn vật liệu khác nhau — không được bỏ qua dù tốn thêm thời gian." },
    { id: "dtm3", t: "Bỏ bước thử nước 24h trước khi nghiệm thu", hd: "Không thử nước thì không phát hiện được điểm thấm sót trước khi cho thi công lớp bảo vệ phía trên — lúc đó muốn sửa phải đập lại." },
  ],
  ht_xay: [
    { id: "dx1", t: "Trộn vữa xây bằng mắt, không theo cấp phối mác", hd: "Cường độ vữa không đạt khi thử mẫu dù tường \"nhìn vẫn chắc\" — phải cân đong đúng tỷ lệ theo mác thiết kế." },
    { id: "dx2", t: "Xây mạch trùng, không so le", hd: "Đặc biệt hay gặp tại góc tường và vị trí giao 2 tường — làm yếu liên kết, dễ nứt theo mạch." },
    { id: "dx3", t: "Vữa trộn quá 2 giờ vẫn tiếp tục dùng", hd: "Vữa đã bắt đầu đông kết, giảm cường độ liên kết dù vẫn còn dẻo khi trộn lại bằng tay — phải bỏ, trộn mới." },
  ],
  ht_trat: [
    { id: "dt1", t: "Trát thẳng lên BT nhẵn không xử lý bám dính", hd: "Bề mặt BT đổ tại chỗ rất nhẵn, không đục nhám/phun hồ dầu trước → lớp trát bong tách sau một thời gian, gõ nghe rỗng." },
    { id: "dt2", t: "Trát dày 1 lần không chờ se mặt giữa các lớp", hd: "Co ngót không đều giữa lớp trong và lớp ngoài → nứt rạn chân chim. Phải trát thành nhiều lớp mỏng đúng quy định." },
    { id: "dt3", t: "Không che chắn, bảo dưỡng khi trát ngoài trời nắng gắt", hd: "Mất nước quá nhanh trước khi đủ cường độ → nứt mặt. Phải tưới ẩm/che chắn theo điều kiện thời tiết thực tế." },
  ],
  ht_lat: [
    { id: "dl1", t: "Không ngâm nước gạch trước khi lát", hd: "Gạch ceramic hút nước nhanh làm vữa mất nước đột ngột → bám dính kém, gạch bộp sau một thời gian dù lát thẳng đẹp." },
    { id: "dl2", t: "Trải vữa không đều, dồn vữa giữa viên gạch", hd: "Gạch bị rỗng đáy quanh viền — chỉ phát hiện khi gõ kiểm tra, nên kiểm tra ngay từng mảng nhỏ, không để lát hết phòng mới gõ." },
    { id: "dl3", t: "Không chừa khe co giãn ở phòng lớn/giáp vật liệu khác", hd: "Nền lát liền mạch toàn bộ diện tích lớn sẽ nứt theo thời gian do co giãn nhiệt — phải chừa khe theo đúng khoảng quy định." },
  ],
  ht_op: [
    { id: "do1", t: "Ốp gạch khổ lớn chỉ bằng vữa thường, không dùng keo dán", hd: "Gạch nặng/khổ lớn cần keo dán chuyên dụng — dùng vữa thường dễ bong rơi nguy hiểm sau thời gian sử dụng." },
    { id: "do2", t: "Không kiểm tra độ phẳng tường nền trước khi ốp", hd: "Mạch gạch có thể đều nhưng cả mặt tường vẫn gợn sóng — phải kiểm tra và xử lý phẳng tường nền trước khi ốp." },
    { id: "do3", t: "Chèn mạch khi keo/vữa dán chưa khô hoàn toàn", hd: "Gạch dễ bị xô lệch trong lúc chèn mạch, làm mạch không đều — đợi đủ thời gian khô theo hướng dẫn vật liệu." },
  ],
  ht_son: [
    { id: "ds1", t: "Sơn lớp tiếp theo khi lớp trước chỉ khô bề mặt", hd: "Nhìn khô nhưng bên trong còn ẩm → bong tróc, nhăn da sau vài tuần. Sờ tay kiểm tra, không chỉ nhìn bằng mắt." },
    { id: "ds2", t: "Pha thêm dung môi sai tỷ lệ để sơn nhanh, tốn ít hơn", hd: "Giảm độ bền màu, dễ bạc màu và bong sớm hơn so với khuyến cáo nhà sản xuất — pha đúng tỷ lệ ghi trên thùng sơn." },
    { id: "ds3", t: "Không kiểm tra độ ẩm tường trát trước khi sơn", hd: "Độ ẩm nên ≤8%, nếu sơn khi còn ẩm sẽ gây mốc, bong từ bên trong dù bề ngoài ban đầu vẫn đẹp." },
  ],
  ht_tran: [
    { id: "dtr1", t: "Khoảng cách ty treo, thanh xương vượt quy định", hd: "Thợ giảm số ty/thanh để tiết kiệm vật tư — trần bị võng rõ sau vài tháng sử dụng, đặc biệt ở giữa phòng." },
    { id: "dtr2", t: "Không gia cường khung phụ tại đèn nặng, miệng gió lớn", hd: "Trần bị sệ cục bộ ngay tại các điểm treo thiết bị nặng nếu chỉ dựa vào khung chính." },
    { id: "dtr3", t: "Trám mạch tấm chỉ 1 lớp, không dán lưới", hd: "Mạch nứt lộ rõ thành đường kẻ sau khi sơn hoàn thiện — phải dán băng lưới và trám tối thiểu 2 lớp." },
  ],
  ht_cua: [
    { id: "dcu1", t: "Lắp khung cửa chỉ canh bằng mắt, không đo đường chéo", hd: "Khung bị méo dù nhìn thẳng — phải đo 2 đường chéo, sai số cho phép rất nhỏ, lệch nhiều thì cánh đóng mở không khít." },
    { id: "dcu2", t: "Chèn khe khung-tường bằng vữa cứng thay vì foam/silicon", hd: "Vữa cứng không co giãn theo nhiệt độ → nứt nẻ, thấm nước quanh khung theo thời gian." },
    { id: "dcu3", t: "Không thử đóng mở nhiều lần trước khi nghiệm thu", hd: "Kẹt, cọ sàn thường chỉ lộ ra sau vài chục lần đóng mở — thử kỹ trước khi sơn bả hoàn thiện xung quanh, tránh phải tháo lại." },
  ],
};
const getDefectsByType = type => defectData[type] || [];

// ── CHUẨN BỊ TRƯỚC KHI GỌI TVGS ─────────────────────────────────────────────────
const prepChecklist = [
  "Đã trả lời đủ 100% hạng mục, không còn mục bỏ trống",
  "Mọi mục Không đạt đã ghi rõ biện pháp khắc phục",
  "Đã chụp ảnh minh chứng đầy đủ, đặc biệt các mục có vấn đề",
  "Đã có đủ phiếu kết quả thí nghiệm vật liệu liên quan (nếu công tác này cần)",
  "Nếu là công tác sắp bị che khuất (cốt thép, ván khuôn...), đã báo TVGS đúng thời gian trước khi chuyển bước tiếp theo",
  "Đã điền đầy đủ thông tin công trình / vị trí / ngày kiểm tra ở đầu checklist",
];
...
function exportPhieuYCNT(session, settings) {
  const today = new Date();
  const html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Phiếu yêu cầu nghiệm thu</title>
  <style>body{font-family:Arial,sans-serif;margin:30px;color:#111;line-height:1.7;}h1{text-align:center;font-size:18px;margin-bottom:2px;}h2{text-align:center;font-size:13px;color:#444;font-weight:normal;margin:0 0 22px;}.info div{margin-bottom:6px;font-size:13.5px;}.box{border:1px solid #999;border-radius:6px;padding:14px 16px;margin:16px 0;font-size:13.5px;}.sign{margin-top:50px;display:flex;justify-content:flex-end;}.signbox{text-align:center;width:230px;font-size:13px;}.note{font-size:11px;color:#888;margin-top:30px;border-top:1px solid #ddd;padding-top:10px;}@media print{button{display:none;}}</style></head>
  <body>
  <h1>PHIẾU YÊU CẦU NGHIỆM THU</h1>
  <h2>${settings.congtrinh || "—"}${settings.hangmuc ? " — " + settings.hangmuc : ""}</h2>
  <div class="info">
    <div><strong>Kính gửi:</strong> ${settings.tvgs ? "Tư vấn giám sát " + settings.tvgs : "Tư vấn giám sát"}${settings.chudt ? "; Chủ đầu tư " + settings.chudt : ""}</div>
    <div><strong>Công trình:</strong> ${settings.congtrinh || "—"}${settings.mahieu ? " (Mã hiệu: " + settings.mahieu + ")" : ""}</div>
    <div><strong>Địa điểm:</strong> ${settings.diachi || "—"}</div>
  </div>
  <div class="box">
    Căn cứ kết quả tự kiểm tra nội bộ, Nhà thầu thi công ${settings.nhathau ? "<strong>" + settings.nhathau + "</strong> " : ""}đề nghị Tư vấn giám sát tổ chức nghiệm thu công việc xây dựng sau:
    <div style="margin-top:10px;"><strong>Tên công việc:</strong> ${session.title}</div>
    <div><strong>Vị trí:</strong> ${session.location || "—"}</div>
    <div><strong>Tiêu chuẩn áp dụng:</strong> ${session.tc || "—"}</div>
    <div><strong>Thời gian đề nghị nghiệm thu:</strong> .......... giờ .......... ngày .......... tháng .......... năm ..........</div>
  </div>
  <div style="font-size:13.5px;">Hồ sơ kèm theo: checklist tự kiểm tra nội bộ, kết quả thí nghiệm vật liệu liên quan (nếu có).</div>
  <div style="text-align:right;margin-top:20px;font-size:13px;color:#444;">${settings.diachi ? settings.diachi.split(",").pop().trim() + ", " : ""}ngày ${today.getDate()} tháng ${today.getMonth() + 1} năm ${today.getFullYear()}</div>
  <div class="sign">
    <div class="signbox"><strong>ĐẠI DIỆN NHÀ THẦU THI CÔNG</strong><div style="margin-top:60px;border-top:1px solid #000;padding-top:6px;">${settings.ksphutrach || ""}</div></div>
  </div>
  <div class="note">ⓘ Mẫu phiếu yêu cầu nghiệm thu tham khảo theo tinh thần NĐ 06/2021/NĐ-CP. Khi dự án có mẫu riêng của TVGS/CĐT, dùng mẫu đó để thay thế.</div>
  <script>window.onload=function(){window.print();}</script>
  </body></html>`;
  const w = window.open("", "_blank");
  if (w) { w.document.write(html); w.document.close(); }
...
function exportBienBanNghiemThu(session, items, results, bienphap, meta, settings) {
  const dC = Object.values(results).filter(v => v === "d").length;
  const kC = Object.values(results).filter(v => v === "k").length;
  const nC = Object.values(results).filter(v => v === "n").length;
  const failedItems = items.filter(it => results[it.id] === "k");
  const lm = { d: "✅ Đạt", k: "❌ Không đạt", n: "— N/A" };
  const rows = items.map((it, i) => {
    const rs = results[it.id], bp = bienphap[it.id] || "";
    return `<tr>
      <td style="padding:8px;border:1px solid #ddd;text-align:center;font-weight:bold;">${i + 1}</td>
      <td style="padding:8px;border:1px solid #ddd;">${it.title}<br><small style="color:#888;">${it.tc}</small></td>
      <td style="padding:8px;border:1px solid #ddd;text-align:center;color:${rs === "d" ? "#16a34a" : rs === "k" ? "#dc2626" : "#888"};font-weight:bold;">${lm[rs] || "—"}</td>
      <td style="padding:8px;border:1px solid #ddd;font-size:12px;color:#c00;">${rs === "k" ? bp || "Chưa nhập BP" : ""}</td>
    </tr>`;
  }).join("");
  const ketluan = kC === 0
    ? `<div style="background:#dcfce7;padding:14px;border-radius:8px;color:#166534;font-weight:600;font-size:13.5px;">✅ Đạt yêu cầu — đề nghị nghiệm thu, cho phép Nhà thầu triển khai công tác tiếp theo.</div>`
    : `<div style="background:#fef2f2;padding:14px;border-radius:8px;color:#991b1b;font-size:13.5px;"><strong>⚠️ Chưa đạt yêu cầu</strong> — yêu cầu Nhà thầu khắc phục các tồn tại sau trước khi nghiệm thu chính thức:
        <ul style="margin:8px 0 0;padding-left:18px;">${failedItems.map(it => `<li>${it.title}${bienphap[it.id] ? " — BP: " + bienphap[it.id] : ""}</li>`).join("")}</ul>
      </div>`;
  const html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Biên bản nghiệm thu công việc xây dựng</title>
  <style>body{font-family:Arial,sans-serif;margin:20px;color:#111;}h1{text-align:center;color:#1e3a8a;font-size:18px;margin-bottom:2px;}h2{text-align:center;font-size:13px;color:#444;font-weight:normal;margin:0 0 16px;}table{width:100%;border-collapse:collapse;margin-top:10px;}th{background:#1e3a8a;color:#fff;padding:9px 8px;text-align:left;font-size:13px;}td{font-size:13px;}.info{display:grid;grid-template-columns:1fr 1fr;gap:8px;background:#f0f4ff;padding:12px;border-radius:8px;margin:12px 0;font-size:13px;}.sec{font-weight:700;color:#1e3a8a;font-size:13.5px;margin:18px 0 6px;}ul.cc{margin:4px 0;padding-left:18px;font-size:13px;}.sign{margin-top:40px;display:grid;grid-template-columns:1fr 1fr;gap:24px;}.signbox{text-align:center;font-size:13px;}.note{font-size:11px;color:#888;margin-top:24px;border-top:1px solid #ddd;padding-top:10px;}@media print{button{display:none;}}</style></head>
  <body>
  <h1>BIÊN BẢN NGHIỆM THU CÔNG VIỆC XÂY DỰNG</h1>
  <h2>${settings.congtrinh || "—"}${settings.hangmuc ? " — " + settings.hangmuc : ""}${settings.mahieu ? " (Mã hiệu: " + settings.mahieu + ")" : ""}</h2>
  <div class="info">
    <div><strong>Địa điểm:</strong> ${settings.diachi || "—"}</div>
    <div><strong>Ngày nghiệm thu:</strong> ${meta.d || "—"}</div>
    <div><strong>Tên công việc:</strong> ${session.title}</div>
    <div><strong>Vị trí:</strong> ${meta.v || "—"}</div>
  </div>
  <div class="sec">1. Thành phần tham gia nghiệm thu</div>
  <div style="font-size:13px;">— Đại diện Tư vấn giám sát: ${settings.tvgs || "..........................................."}<br/>— Đại diện Nhà thầu thi công: ${settings.nhathau || "..........................................."}${meta.k ? " (KS giám sát thi công: " + meta.k + ")" : ""}</div>
  <div class="sec">2. Căn cứ nghiệm thu</div>
  <ul class="cc">
    <li>Tiêu chuẩn áp dụng: ${session.tc || "—"}</li>
    <li>Nghị định 06/2021/NĐ-CP, Điều 13 — Nghiệm thu công việc xây dựng</li>
    <li>Nghị định 06/2021/NĐ-CP, Điều 14 — Nghiệm thu công việc xây dựng bị che khuất (nếu thuộc bộ phận che khuất)</li>
  </ul>
  <div class="sec">3. Nội dung nghiệm thu</div>
  <table><thead><tr><th style="width:36px;">#</th><th>Hạng mục kiểm tra</th><th style="width:110px;">Kết quả</th><th>Biện pháp khắc phục</th></tr></thead><tbody>${rows}</tbody></table>
  <div style="display:flex;gap:14px;margin:10px 0;font-size:12.5px;color:#444;"><span>Đạt: <strong style="color:#16a34a;">${dC}</strong></span><span>Không đạt: <strong style="color:#dc2626;">${kC}</strong></span><span>N/A: <strong>${nC}</strong></span></div>
  <div class="sec">4. Kết luận</div>
  ${ketluan}
  <div class="sign">
    <div class="signbox"><strong>ĐẠI DIỆN TƯ VẤN GIÁM SÁT</strong><div style="margin-top:55px;border-top:1px solid #000;padding-top:6px;">${settings.tvgs || ""}</div></div>
    <div class="signbox"><strong>ĐẠI DIỆN NHÀ THẦU THI CÔNG</strong><div style="margin-top:55px;border-top:1px solid #000;padding-top:6px;">${settings.ksphutrach || ""}</div></div>
  </div>
  <div class="note">ⓘ Biên bản nghiệm thu công việc xây dựng tại hiện trường chỉ TVGS và Nhà thầu ký theo NĐ 06/2021/NĐ-CP, Đ.13. Mẫu tham khảo — khi dự án có mẫu riêng của TVGS/CĐT, dùng mẫu đó để thay thế.</div>
  <script>window.onload=function(){window.print();}</script>
  </body></html>`;
  const w = window.open("", "_blank");
  if (w) { w.document.write(html); w.document.close(); }
...
const QCM_KEYS = ["qcm_sessions", "qcm_loi", "qcm_nk", "qcm_sp", "qcm_gen", "qcm_xlsx_list", "qcm_settings"];
const exportAllData = () => {
  const data = {};
  QCM_KEYS.forEach(k => { const v = localStorage.getItem(k); if (v != null) data[k] = v; });
  const payload = { app: "qc-field-manager", version: 1, exportedAt: new Date().toISOString(), data };
  const blob = new Blob([JSON.stringify(payload, null, 2)], { type: "application/json" });
  const url = URL.createObjectURL(blob);
  const a = document.createElement("a");
  a.href = url; a.download = `qcm-backup-${new Date().toISOString().slice(0, 10)}.json`;
  document.body.appendChild(a); a.click(); a.remove();
  URL.revokeObjectURL(url);
};
const importAllData = (file, onDone) => {
  ...
  r.onerror = () => onDone(new Error("read"));
  r.readAsText(file);
};
...
// ── LỖI THƯỜNG GẶP MODAL ─────────────────────────────────────────────────────
function DefectModal({ type, onClose }) {
  const defects = getDefectsByType(type);
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.65)", zIndex: 500, display: "flex", alignItems: "flex-end", justifyContent: "center" }} onClick={onClose}>
      <div onClick={e => e.stopPropagation()} style={{ background: "#fff", borderRadius: "22px 22px 0 0", width: "100%", maxWidth: 480, maxHeight: "88vh", overflowY: "auto", paddingBottom: 32 }}>
        <div style={{ padding: "16px 20px 12px", borderBottom: "1.5px solid #f1f5f9", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, background: "#fff", zIndex: 1 }}>
          <div style={{ fontSize: 16, fontWeight: 800, color: "#d97706" }}>⚠️ Lỗi thường gặp</div>
          <button onClick={onClose} style={{ width: 40, height: 40, borderRadius: 10, background: "#f1f5f9", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}><Ic n="x" s={18} c="#374151" /></button>
        </div>
        <div style={{ padding: 16 }}>
          {defects.length === 0 && <div style={{ textAlign: "center", color: "#94a3b8", padding: "24px 0", fontSize: 13 }}>Chưa có dữ liệu cho loại công tác này.</div>}
          {defects.map(d => (
            <div key={d.id} style={{ background: "#fffbeb", border: "1.5px solid #fde68a", borderRadius: 14, padding: "14px 16px", marginBottom: 10 }}>
              <div style={{ fontSize: 13.5, fontWeight: 700, color: "#92400e", marginBottom: 4 }}>{d.t}</div>
              <div style={{ fontSize: 12.5, color: "#78350f", lineHeight: 1.6 }}>{d.hd}</div>
            </div>
          ))}
        </div>
      </div>
...
function GenCL({ items, session, onUpdate }) {
  ...
  return (
    <div style={{ padding: "0 16px 16px" }}>
      ...
      <button onClick={() => setShowDefects(true)} style={{ width: "100%", padding: "10px 14px", borderRadius: 12, background: "#fffbeb", color: "#92400e", border: "1.5px solid #fde68a", fontSize: 12.5, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, marginBottom: 16, ...T }}>
        ⚠️ Lỗi thường gặp ở công tác này
      </button>
      ...
      <button onClick={() => { setPrepChecked({}); setShowReport(true); }} disabled={!allDone} style={{ width: "100%", padding: "15px", borderRadius: 14, background: allDone ? NAVY : "#e2e8f0", color: allDone ? "#fff" : "#94a3b8", border: "none", fontSize: 15, fontWeight: 700, cursor: allDone ? "pointer" : "not-allowed", ...T }}>
      ...
      {showDefects && <DefectModal type={session.type} onClose={() => setShowDefects(false)} />}
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.55)", zIndex: 200, display: "flex", alignItems: "flex-end", justifyContent: "center" }} onClick={() => setShowReport(false)}>
          <div onClick={e => e.stopPropagation()} style={{ background: "#fff", borderRadius: "20px 20px 0 0", width: "100%", maxWidth: 480, maxHeight: "88vh", overflowY: "auto", padding: "20px 18px 32px" }}>
            ...
            <div style={{ background: "#f0fdf4", border: "1.5px solid #bbf7d0", borderRadius: 12, padding: "12px 14px", marginBottom: 16 }}>
              <div style={{ fontSize: 12.5, fontWeight: 700, color: "#166534", marginBottom: 8 }}>📝 Trước khi gọi TVGS nghiệm thu</div>
              {prepChecklist.map((p, i) => (
                <label key={i} style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: i < prepChecklist.length - 1 ? 6 : 0, cursor: "pointer" }}>
                  <input type="checkbox" checked={!!prepChecked[i]} onChange={() => setPrepChecked(pc => ({ ...pc, [i]: !pc[i] }))} style={{ marginTop: 2, flexShrink: 0 }} />
                  <span style={{ fontSize: 12, color: "#166534", lineHeight: 1.5, textDecoration: prepChecked[i] ? "line-through" : "none", opacity: prepChecked[i] ? 0.6 : 1 }}>{p}</span>
                </label>
              ))}
            </div>
            {items.map((it, i) => {
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 16 }}>
              ...
              <button onClick={() => exportPDF(session.title, items, results, bienphap, meta, session.tc, photos)} style={{ flex: 1, padding: "14px", background: NAVY, color: "#fff", border: "none", borderRadius: 12, fontSize: 14, fontWeight: 700, cursor: "pointer", ...T }}>🖨️ Checklist nội bộ</button>
            </div>
            <div style={{ display: "flex", gap: 10, marginTop: 10 }}>
              <button onClick={() => exportPhieuYCNT(session, initSettings())} style={{ flex: 1, padding: "14px", background: "#0f766e", color: "#fff", border: "none", borderRadius: 12, fontSize: 13.5, fontWeight: 700, cursor: "pointer", ...T }}>📋 Phiếu YCNT</button>
              <button onClick={() => exportBienBanNghiemThu(session, items, results, bienphap, meta, initSettings())} style={{ flex: 1, padding: "14px", background: "#7c2d12", color: "#fff", border: "none", borderRadius: 12, fontSize: 13.5, fontWeight: 700, cursor: "pointer", ...T }}>📄 Biên bản NT</button>
            </div>
          </div>
        </div>
      )}
  ...
  const handleUpload = e => {
    ...
    reader.onload = ev => {
      try {
        ...
        sLoading(false);
      } catch { sUpErr("Lỗi đọc file. Kiểm tra file .xlsx và thử lại."); sLoading(false); }
    };
...
function CLScreen({ setST }) {
  const SK = "qcm_gen";
  const init = () => { try { const s = localStorage.getItem(SK); if (s) return JSON.parse(s); } catch { } return {}; };
  const [ck, sCk] = useState(init);
  const [oc, sOC] = useState(1);
  const sC = fn => { sCk(p => { const n = fn(p); try { localStorage.setItem(SK, JSON.stringify(n)); } catch { } return n; }); };
...
function NKScreen({ loiList, sLL, nkList, sNKL }) {
  ...
  const [form, sForm] = useState({ vt: "", mt: "", md: "Trung bình", tt: "Mới", deadline: "" });
  ...
  const addL = () => {
    ...
    sForm({ vt: "", mt: "", md: "Trung bình", tt: "Mới", deadline: "" }); sPh([]); sSF(false);
  };
  ...
  const svNK = v => {
    ...
    try { localStorage.setItem("qcm_nk", JSON.stringify(n)); } catch { }
    sNKL(n);
  };
  ...
  return <div style={{ padding: "0 16px 16px" }}>
    <div style={{ display: "flex", background: "#f1f5f9", borderRadius: 12, padding: 4, marginBottom: 16, gap: 4 }}>
      {[["loi", "📋 Theo dõi tồn tại"], ["tc", "📓 Nhật ký TC"]].map(([m, l]) => <button key={m} onClick={() => sM(m)} style={{ flex: 1, padding: "10px 8px", borderRadius: 9, border: "none", cursor: "pointer", fontSize: 12.5, fontWeight: 700, background: mode === m ? "#fff" : "transparent", color: mode === m ? NAVY : "#64748b", boxShadow: mode === m ? "0 1px 4px rgba(0,0,0,0.1)" : "none", ...T }}>{l}</button>)}
    </div>
    ...
    {mode === "loi" && <>
      ...
      <button onClick={() => sSF(!sf)} style={{ width: "100%", padding: "13px", borderRadius: 12, background: sf ? "#f1f5f9" : NAVY, color: sf ? NAVY : "#fff", border: "none", fontSize: 14, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 14, ...T }}><Ic n="plus" s={18} c={sf ? NAVY : "#fff"} />{sf ? "Đóng" : "Ghi tồn tại mới"}</button>
      {sf && <div style={{ background: "#fff", borderRadius: 14, padding: 16, marginBottom: 14, border: "1.5px solid #e2e8f0" }}>
        ...
        <div style={{ marginBottom: 12 }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: "#374151", marginBottom: 4 }}>📅 Hạn khắc phục</div><input type="date" value={form.deadline} onChange={e => sForm(p => ({ ...p, deadline: e.target.value }))} style={{ width: "100%", padding: "11px 12px", borderRadius: 10, border: "1.5px solid #e2e8f0", fontSize: 13, outline: "none", boxSizing: "border-box", ...T }} />
        </div>
        ...
        <button onClick={addL} style={{ width: "100%", padding: 13, background: NAVY, color: "#fff", border: "none", borderRadius: 10, fontSize: 14, fontWeight: 600, cursor: "pointer", ...T }}>Lưu tồn tại</button>
      </div>}
      {shown.map(loi => <div key={loi.id} style={{ background: "#fff", borderRadius: 14, padding: "14px 16px", marginBottom: 10, border: "1.5px solid #e2e8f0" }}>
        ...
        <div style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
          ...
          {loi.closureNote && <span onClick={() => setViewClosure(loi)} style={{ fontSize: 11, background: "#f0fdf4", color: "#16a34a", padding: "4px 10px", borderRadius: 99, cursor: "pointer" }}>✓ Đã khắc phục ›</span>}
          <span style={{ fontSize: 11, color: "#94a3b8", marginLeft: "auto" }}>{loi.ng}</span>
        </div>
      </div>)}
      {vp && <div onClick={() => sVP(null)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.85)", zIndex: 500, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}><img src={vp} style={{ maxWidth: "100%", maxHeight: "80vh", borderRadius: 12 }} alt="" /></div>}
      {viewClosure && <div onClick={() => setViewClosure(null)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.55)", zIndex: 400, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
        <div onClick={e => e.stopPropagation()} style={{ background: "#fff", borderRadius: "22px 22px 0 0", width: "100%", maxWidth: 480, padding: 20, paddingBottom: 32 }}>
          <div style={{ fontSize: 15, fontWeight: 800, color: "#16a34a", marginBottom: 4 }}>✓ Đã khắc phục</div>
          <div style={{ fontSize: 12, color: "#64748b", marginBottom: 14 }}>📍 {viewClosure.vt} — {viewClosure.mt}</div>
          {viewClosure.closureNote && <div style={{ marginBottom: 12 }}>
            <div style={{ fontSize: 12, fontWeight: 600, color: "#374151", marginBottom: 4 }}>Biện pháp xử lý</div>
            <div style={{ fontSize: 13, color: "#1e293b", lineHeight: 1.5, background: "#f8fafc", borderRadius: 8, padding: "8px 12px" }}>{viewClosure.closureNote}</div>
          </div>}
          {viewClosure.closedAt && <div style={{ fontSize: 11, color: "#94a3b8", marginBottom: 12 }}>🕓 Đóng lúc: {new Date(viewClosure.closedAt).toLocaleString("vi-VN")}</div>}
          {viewClosure.closurePhotos && viewClosure.closurePhotos.length > 0 ? <div>
            <div style={{ fontSize: 12, fontWeight: 600, color: "#374151", marginBottom: 6 }}>📸 Ảnh bằng chứng</div>
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>{viewClosure.closurePhotos.map((p, i) => <img key={i} src={p} onClick={() => sVP(p)} style={{ width: 72, height: 72, borderRadius: 10, objectFit: "cover", cursor: "pointer", border: "1.5px solid #e2e8f0" }} alt="" />)}</div>
          </div> : <div style={{ fontSize: 12, color: "#94a3b8" }}>Không có ảnh bằng chứng.</div>}
          <button onClick={() => setViewClosure(null)} style={{ width: "100%", marginTop: 16, padding: 13, background: "#f1f5f9", color: "#374151", border: "none", borderRadius: 10, fontSize: 14, fontWeight: 600, cursor: "pointer", ...T }}>Đóng</button>
        </div>
      </div>}
      {closingLoi && <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.55)", zIndex: 400, display: "flex", alignItems: "flex-end", justifyContent: "center" }} onClick={() => setClosingLoi(null)}>
        <div onClick={e => e.stopPropagation()} style={{ background: "#fff", borderRadius: "22px 22px 0 0", width: "100%", maxWidth: 480, padding: 20, paddingBottom: 32 }}>
          <div style={{ fontSize: 15, fontWeight: 800, color: NAVY, marginBottom: 4 }}>✅ Xác nhận đã khắc phục</div>
          ...
          <div style={{ marginBottom: 12 }}>
            ...
            <textarea value={closureForm.note} onChange={e => setClosureForm(f => ({ ...f, note: e.target.value }))} placeholder="Mô tả cách đã khắc phục tồn tại..." rows={3} style={{ width: "100%", padding: "10px 12px", borderRadius: 10, border: "1.5px solid #e2e8f0", fontSize: 13, outline: "none", resize: "none", boxSizing: "border-box" }} />
          </div>
          <div style={{ marginBottom: 14 }}>
...
function TNScreen({ samp, setSamp }) {
  ...
  const svS = v => {
    ...
    try { localStorage.setItem("qcm_sp", JSON.stringify(n)); } catch { }
    setSamp(n);
  };
...
const initSettings = () => { try { const s = localStorage.getItem("qcm_settings"); if (s) return JSON.parse(s); } catch {} return { congtrinh: "", hangmuc: "", mahieu: "", diachi: "", chudt: "", tvgs: "", nhathau: "", ksphutrach: "", email: "" }; };
...
function WeeklyReportScreen({ loiList, nkList, samp, sessions = [] }) {
  ...
  const handleImport = e => {
    ...
    if (!file) return;
    if (!window.confirm("Phục hồi sẽ GHI ĐÈ toàn bộ dữ liệu hiện tại trên thiết bị bằng dữ liệu trong file sao lưu. Tiếp tục?")) return;
    importAllData(file, (err, n) => {
      if (err) { alert("File sao lưu không hợp lệ hoặc không có dữ liệu."); return; }
      alert(`Đã phục hồi ${n} mục dữ liệu. Ứng dụng sẽ tải lại.`);
  ...
  return <div style={{ padding: "0 16px 16px" }}>
    ...
    {activeTab === "settings" && <div>
      ...
      {[["🏗️ Tên công trình / Dự án", "congtrinh", "VD: Chung cư ABC - Tòa A"], ["🧱 Hạng mục công trình", "hangmuc", "VD: Phần thân - Tầng 5"], ["🔖 Mã hiệu công trình", "mahieu", "VD: ABC-TA-05"], ["📍 Địa điểm", "diachi", "VD: Quận 7, TP.HCM"], ["🏢 Chủ đầu tư", "chudt", "VD: Công ty CP XYZ"], ["👁️ Tư vấn giám sát", "tvgs", "VD: Công ty TVGS ABC"], ["🏗️ Nhà thầu thi công", "nhathau", "VD: Công ty XD DEF"], ["👷 KS phụ trách QC", "ksphutrach", "VD: Nguyễn Văn A"], ["📧 Email gửi báo cáo", "email", "VD: giamdoc@congty.vn"]].map(([label, key, ph]) =>
      ...
      <div style={{ background: "#fff", borderRadius: 14, padding: "14px 16px", border: "1.5px solid #e2e8f0", marginBottom: 12 }}>
        <div style={{ fontSize: 13, fontWeight: 700, color: NAVY, marginBottom: 4 }}>💾 Sao lưu & phục hồi dữ liệu</div>
        <div style={{ fontSize: 12, color: "#64748b", marginBottom: 12, lineHeight: 1.5 }}>Toàn bộ dữ liệu chỉ lưu trên thiết bị này. Hãy sao lưu định kỳ ra file <strong>.json</strong> để không mất khi đổi máy hoặc xóa cache, và để chuyển dữ liệu sang thiết bị khác.</div>
        <div style={{ display: "flex", gap: 10 }}>
          <button onClick={exportAllData} style={{ flex: 1, padding: 13, background: NAVY, color: "#fff", border: "none", borderRadius: 10, fontSize: 13.5, fontWeight: 600, cursor: "pointer", ...T }}>⬇️ Sao lưu</button>
          <label style={{ flex: 1, padding: 13, background: "#f1f5f9", color: NAVY, borderRadius: 10, fontSize: 13.5, fontWeight: 600, cursor: "pointer", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", ...T }}>⬆️ Phục hồi<input type="file" accept="application/json,.json" onChange={handleImport} style={{ display: "none" }} /></label>
        </div>
        <div style={{ fontSize: 11, color: "#dc2626", marginTop: 10 }}>⚠️ Phục hồi sẽ ghi đè toàn bộ dữ liệu hiện tại.</div>
      </div>
    </div>}
    {activeTab === "analytics" && (() => {
      ...
      const loiOverview = { total: loiList.length, moi: 0, dang: 0, xong: 0, overdue: 0, cao: 0 };
      loiList.forEach(l => {
        if (l.tt === "Mới") loiOverview.moi++;
        else if (l.tt === "Đang xử lý") loiOverview.dang++;
        else if (l.tt === "Đã xong") loiOverview.xong++;
        if (l.deadline && l.deadline < today && l.tt !== "Đã xong") loiOverview.overdue++;
        if (l.md === "Cao" && l.tt !== "Đã xong") loiOverview.cao++;
      });
      return <div>
        ...
        <div style={{ background: "#fff", borderRadius: 14, padding: "14px 16px", marginBottom: 14, border: "1.5px solid #e2e8f0" }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: NAVY, marginBottom: 10 }}>📈 Xu hướng tồn tại (4 tuần)</div>
        ...
        <div style={{ background: "#fff", borderRadius: 14, padding: "14px 16px", marginBottom: 14, border: "1.5px solid #e2e8f0" }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: NAVY, marginBottom: 10 }}>📋 Tổng quan tồn tại</div>
          {loiOverview.total === 0 ? <div style={{ textAlign: "center", padding: 16, color: "#94a3b8" }}>Chưa có tồn tại nào được ghi nhận.</div> : <>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
              {[["Tổng", loiOverview.total, "#eff6ff", NAVY], ["Mới", loiOverview.moi, "#fef2f2", "#ef4444"], ["Đang xử lý", loiOverview.dang, "#fffbeb", "#d97706"], ["Đã khắc phục", loiOverview.xong, "#f0fdf4", "#16a34a"]].map(([l, v, bg, c]) =>
                <div key={l} style={{ background: bg, borderRadius: 10, padding: "10px 6px", textAlign: "center" }}>
                  <div style={{ fontSize: 20, fontWeight: 800, color: c }}>{v}</div>
                  <div style={{ fontSize: 9.5, color: c, marginTop: 2 }}>{l}</div>
                </div>
              )}
            </div>
            {(loiOverview.overdue > 0 || loiOverview.cao > 0) && <div style={{ display: "flex", gap: 8, marginTop: 10, flexWrap: "wrap" }}>
              {loiOverview.overdue > 0 && <span style={{ fontSize: 12, fontWeight: 600, background: "#fef2f2", color: "#dc2626", padding: "6px 12px", borderRadius: 99 }}>📅 {loiOverview.overdue} quá hạn</span>}
              {loiOverview.cao > 0 && <span style={{ fontSize: 12, fontWeight: 600, background: "#fff7ed", color: "#ea580c", padding: "6px 12px", borderRadius: 99 }}>⚠ {loiOverview.cao} mức độ Cao chưa xử lý</span>}
            </div>}
          </>}
        </div>
    ...
    {activeTab === "report" && <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 14 }}>
        {[["📓", "Ngày ghi NK", nkTuan.length, "#eff6ff", NAVY], ["❗", "Tồn tại mới", loiMoi.length, "#fef2f2", "#ef4444"], ["⚠️", "Tồn đọng", loiTon.length, "#fffbeb", "#d97706"], ["🧪", "Tổ mẫu lấy", sampTuan.length, "#f0fdf4", "#16a34a"]].map(([ic, l, c, bg, col]) =>
...
function Dash({ setTab, loiList, nkList, samp }) {
  ...
  return <div style={{ padding: "0 16px 16px" }}>
    ...
    {(overdue > 0 || todayT > 0 || nc > 0 || overdueLoiDl > 0) && <div style={{ background: overdue > 0 ? "#fef2f2" : todayT > 0 ? "#fff7ed" : "#eff6ff", borderRadius: 14, padding: "12px 16px", marginBottom: 14, borderLeft: "4px solid " + (overdue > 0 ? "#ef4444" : todayT > 0 ? "#ea580c" : NAVY) }}>
      ...
      {overdueLoiDl > 0 && <div style={{ fontSize: 13, fontWeight: 700, color: "#dc2626" }}>🔴 {overdueLoiDl} tồn tại QUÁ HẠN khắc phục — chưa đóng!</div>}
      {nc > 0 && <div style={{ fontSize: 13, fontWeight: 600, color: NAVY }}>🔵 {nc} tồn tại mới chưa xử lý</div>}
    </div>}
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 16 }}>
      {[["Tồn tại mới", nc, "#ef4444", "#fef2f2"], ["Đang XL", pc, "#d97706", "#fffbeb"], ["Đã xong", dc, "#16a34a", "#f0fdf4"]].map(([l, c, cl, bg]) => <div key={l} style={{ background: bg, borderRadius: 12, padding: "12px 10px", textAlign: "center" }}><div style={{ fontSize: 22, fontWeight: 800, color: cl }}>{c}</div><div style={{ fontSize: 11, color: cl, fontWeight: 600 }}>{l}</div></div>)}
    </div>
...
export default function App() {
  ...
  const initLoiList = () => { try { const s = localStorage.getItem("qcm_loi"); if (s) return JSON.parse(s); } catch { } return loiInit; };
  const initNKList = () => { try { const s = localStorage.getItem("qcm_nk"); if (s) return JSON.parse(s); } catch { } return nkInit; };
  const initSamp = () => { try { const s = localStorage.getItem("qcm_sp"); if (s) return JSON.parse(s); } catch { } return []; };
  ...
  const sLL = v => {
    ...
    try { localStorage.setItem("qcm_loi", JSON.stringify(n)); } catch { }
    sLL_raw(n);
  };
  const sNKL = v => {
    const n = typeof v === "function" ? v(nkList) : v;
